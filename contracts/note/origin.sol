...
//         uint256 healthFactor;    
//         (, totalDebtETH, , , , healthFactor) = lendingPool.getUserAccountData(target);
...
//         uint112 wethUsdtR0;
//         uint112 wethUsdtR1;
//         (wethUsdtR0, wethUsdtR1, ) = wethUsdtPair.getReserves();

//         // console.log("AmountIn weth usdt", getAmountOut(totalDebtETH * 50 / 100 ,wethUsdtR0 ,wethUsdtR1));
//         // uint aout = getAmountOut(totalDebtETH * 50 / 100 ,wethUsdtR0 ,wethUsdtR1);

//         bytes memory data = abi.encode("swapping");
    
//         console.log("AmountIn usdt weth", getAmountIn(2916378221684 ,wethUsdtR0 ,wethUsdtR1));

//         // 2. call flash swap to liquidate the target user
//         // Currently hard code max liquidation amount possible.
...
//         (wbtcWethR0, wbtcWethR1, ) = wethWbtcPair.getReserves();

//         uint swapBalance = wbtc.balanceOf(address(this));
//         uint ethAmount = getAmountOut(swapBalance, wbtcWethR0, wbtcWethR1);
...
//         uint repayAmountEth = getAmountIn(debt, wethUsdtR0, wethUsdtR1);
